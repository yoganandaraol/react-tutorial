...
`<noscript>` tag shows the configured message, in case javascript is disabled in the browser.

<br />
<hr />

* Components in react uses `jsx` for tempating.
* In `ReactDOM.render(<App />, document.getElementById('root'));` render method, the first parameter (`<App />`) takes jsx parameter.
* 
